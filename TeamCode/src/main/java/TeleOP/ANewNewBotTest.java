...
@TeleOp
public class ANewNewBotTest extends LinearOpMode {
    ...
    public static final double WRIST_OPEN_POS = -1;
    public static final double WRIST_CLOSED_POS = 1;
    public static final double WRIST_HANG_SPEC_POS = 0.45;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (TuningOpModes.DRIVE_CLASS.equals(MecanumDrive.class)) {
            ...
            while (opModeIsActive()) {
                ...
                if (gamepad2.b && !lastBump) {
                    wristOpen = !wristOpen; //maybe set this to either false or true?
                    wrist.setPosition(WRIST_HANG_SPEC_POS);
                }
                /*if (gamepad2.y && !lastBump) {
                    wristClosed= !wristClosed;
                    wrist.setPosition(WRIST_CLOSED_POS);
                }*/
